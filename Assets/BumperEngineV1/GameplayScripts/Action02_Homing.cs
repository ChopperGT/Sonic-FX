...
public class Action02_Homing : MonoBehaviour {
    ...
    public void InitialEvents()
    {
        ...
        if (isAdditive)
        {
            ...
            float XZmag = new Vector3(Player.p_rigidbody.linearVelocity.x, 0, Player.p_rigidbody.linearVelocity.z).magnitude;
    ...
    void Update()
    {
        ...
        //Set Animation Angle
        Vector3 VelocityMod = new Vector3(Player.p_rigidbody.linearVelocity.x, 0, Player.p_rigidbody.linearVelocity.z);
    ...
    void FixedUpdate()
    {
        ...
        if (IsAirDash)
        {
            ...
            {
                Player.p_rigidbody.linearVelocity = transform.TransformDirection(Player.RawInput) * Aspeed;
            }
            else
            {
               // //Debug.Log("prev");
                Player.p_rigidbody.linearVelocity = transform.TransformDirection(Player.PreviousRawInput) * Aspeed;
            }
        ...
        else
        {
            ...
            Player.p_rigidbody.linearVelocity = direction.normalized * Speed;
        }
