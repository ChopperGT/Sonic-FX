...
public class Action06_Bounce : MonoBehaviour {
    ...
    public void InitialEvents()
    {
		...
		Player.p_rigidbody.linearVelocity = new Vector3 (Player.p_rigidbody.linearVelocity.x/BounceHaltFactor, 0, Player.p_rigidbody.linearVelocity.z/BounceHaltFactor);
	...
	private void Bounce(Vector3 normal)
	{
		...
		Player.p_rigidbody.linearVelocity = new Vector3 (Player.p_rigidbody.linearVelocity.x, CurrentBounceAmount, Player.p_rigidbody.linearVelocity.z);
	...
	private void Stomp()
	{
		Player.p_rigidbody.linearVelocity = new Vector3 (0,0,0);
		ResetValues ();
		//Set Animator Parameters
